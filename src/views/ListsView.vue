...
const { allLists, currentList, lastUsedList, isSubscribedToNotifications } = storeToRefs(listsStore);
      ...
      <template v-if="!Component">
        <div class="lists">
          <div class="list-tools">
            <h1>{{ t("Lists") }}</h1>
            <button type="button" class="notify-button" @click="toggleSubscription">
              <svg v-if="!isSubscribedToNotifications" xmlns="http://www.w3.org/2000/svg" stroke-width="2" viewBox="0 0 24 24">
